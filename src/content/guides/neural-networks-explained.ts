...
export const guide: Guide = {
  ...
  coreConcepts: [
    ...
    },
    {
      ...
      detail:
        "In practice this is one matrix multiplication, which is precisely why GPUs are so effective here — they were designed to multiply large matrices fast for graphics, and the operation turned out to be identical.",
    },
    {
  ...
  mistakes: [
    ...
    },
    {
      ...
      fix: "Start from a pre-trained model and adapt it. Training from scratch is justified only when your domain genuinely doesn't resemble anything a public model has seen.",
    },
    {
  ...
  businessApplications: [
    ...
    "Demand and time-series forecasting where the signal is genuinely complex — though be honest about whether it is, since simpler methods win more often than practitioners expect.",
  ...
  faqs: [
    {
      ...
      a: "To use them, no — frameworks compute gradients automatically. To debug them properly, a conceptual grasp of what a derivative represents is genuinely useful. You need the intuition much more than the ability to differentiate by hand.",
    },
    {
