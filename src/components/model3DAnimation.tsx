...
export const PerformanceNodes: FC = () => {
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      // ── Subtle centre glow for atmosphere (dark theme only) ───────────────
      if (isDark) {
  ...
  return (
    <Box
      ...
      sx={{
        ...
        overflow:        "hidden",
        backgroundColor: bgColor,     // ← matches the site background
        borderRadius:    "16px",
      }}
    >
      <canvas
        ...
        {[
          ...
          <Box key={label} sx={{ display: "flex", alignItems: "center", gap: "6px" }}>
            ...
            <Box sx={{
              fontSize:   "10px",
              fontFamily: "Prompt",
              color:      isDark ? "rgba(255,255,255,0.45)" : "rgba(0,25,50,0.55)",
            }}>
              {label}
            </Box>
          </Box>
      ...
      <Box sx={{
        ...
        fontSize:      "10px",
        fontFamily: "Prompt"  ,
        color:         isDark ? "rgba(255,255,255,0.22)" : "rgba(0,25,50,0.35)",
        pointerEvents: "none",
        userSelect:    "none",
      }}>
